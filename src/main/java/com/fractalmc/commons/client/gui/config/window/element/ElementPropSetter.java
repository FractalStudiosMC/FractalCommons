...
import com.fractalmc.commons.client.gui.Theme;
import com.fractalmc.commons.client.gui.config.GuiConfigs;
import com.fractalmc.commons.client.gui.config.window.WindowSetIntArray;
import com.fractalmc.commons.client.gui.config.window.WindowSetKeyBind;
import com.fractalmc.commons.client.gui.config.window.WindowSetNestedIntArray;
import com.fractalmc.commons.client.gui.config.window.WindowSetStringArray;
import com.fractalmc.commons.client.gui.window.Window;
import com.fractalmc.commons.client.gui.window.element.*;
        ...
        public Tree draw(int mouseX, int mouseY, boolean hover, int width, int treeHeight, boolean hasScroll, int totalHeight, boolean clicking, boolean rClicking)
        {
            ...
            if(realBorder && clicking && !obstructed)
            {
                ...
                if(clz.equals(KeyBind.class))
                {
                    ...
                    {
                        parent.workspace.addWindowOnTop(new WindowSetKeyBind((GuiConfigs)parent.workspace, 300, 200, 180, 80, "fractalcommons.config.gui.hitKeys", config, propInfo).putInMiddleOfScreen());
                    }
                }
                else if(clz.equals(String[].class))
                {
