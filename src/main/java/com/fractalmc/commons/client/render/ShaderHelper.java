...
public final class ShaderHelper
{
    ...
    public static void useShader(int shader, IShaderCallback callback)
    {
        ...
        if (shader != 0)
        {
            float frameTime = FractalCommons.eventHandlerClient.ticks + FractalCommons.eventHandlerClient.renderTick;
    ...
    public static int createProgram(String vert, String frag)
    {
        ...
        {
            FractalCommons.internalLogger.logError(getLogInfo(program));
    ...
    {
        void call(int shader, boolean newFrame);
    }
}
