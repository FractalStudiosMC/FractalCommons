package com.fractalmc.commons.client.render.world;
        ...
        switch(type)
        {
            case 2000:
                ...
                for(int k1 = 0; k1 < 10; ++k1)
                {
                    ...
                    spawnParticle(EnumParticleTypes.SMOKE_NORMAL.getParticleID(), EnumParticleTypes.SMOKE_NORMAL.getShouldIgnoreRange(), d14, d17, d20, d23, d25, d27, new int[0]);
                }
            ...
            case 2007:
                ...
                {
                    spawnParticle(EnumParticleTypes.ITEM_CRACK.getParticleID(), EnumParticleTypes.ITEM_CRACK.getShouldIgnoreRange(), d6, d7, d9, random.nextGaussian() * 0.15D, random.nextDouble() * 0.2D, random.nextGaussian() * 0.15D, new int[] { Item.getIdFromItem(Items.SPLASH_POTION) });
                }
            ...
            case 2003:
                ...
                for(int j = 0; j < 8; ++j)
                {
                    spawnParticle(EnumParticleTypes.ITEM_CRACK.getParticleID(), EnumParticleTypes.ITEM_CRACK.getShouldIgnoreRange(), d0, d1, d2, random.nextGaussian() * 0.15D, random.nextDouble() * 0.2D, random.nextGaussian() * 0.15D, new int[] { Item.getIdFromItem(Items.ENDER_EYE) });
                }

                for(double d11 = 0.0D; d11 < (Math.PI * 2D); d11 += 0.15707963267948966D)
                {
                    spawnParticle(EnumParticleTypes.PORTAL.getParticleID(), EnumParticleTypes.PORTAL.getShouldIgnoreRange(), d0 + Math.cos(d11) * 5.0D, d1 - 0.4D, d2 + Math.sin(d11) * 5.0D, Math.cos(d11) * -5.0D, 0.0D, Math.sin(d11) * -5.0D, new int[0]);
                    spawnParticle(EnumParticleTypes.PORTAL.getParticleID(), EnumParticleTypes.PORTAL.getShouldIgnoreRange(), d0 + Math.cos(d11) * 5.0D, d1 - 0.4D, d2 + Math.sin(d11) * 5.0D, Math.cos(d11) * -7.0D, 0.0D, Math.sin(d11) * -7.0D, new int[0]);
                }
            ...
            case 2004:
                ...
                for(int l1 = 0; l1 < 20; ++l1)
                {
                    ...
                    world.spawnParticle(EnumParticleTypes.SMOKE_NORMAL, d15, d18, d21, 0.0D, 0.0D, 0.0D, new int[0]);
                    world.spawnParticle(EnumParticleTypes.FLAME, d15, d18, d21, 0.0D, 0.0D, 0.0D, new int[0]);
                }
            ...
            case 2006:
                ...
                for(int l = 0; l < 200; ++l)
                {
                    ...
                    Particle particle = spawnParticle0(EnumParticleTypes.DRAGON_BREATH.getParticleID(), false, (double)blockPosIn.getX() + d3 * 0.1D, (double)blockPosIn.getY() + 0.3D, (double)blockPosIn.getZ() + d5 * 0.1D, d3, d4, d5, new int[0]);
