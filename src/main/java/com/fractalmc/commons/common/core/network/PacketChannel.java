package com.fractalmc.commons.common.core.network;
...
public class PacketChannel
{
...

    {
        ...
        catch(Exception e)
        {
            ...
            FMLLog.log(Level.FATAL, e, "What? Netty isn't installed, what magic is this? hfuwqhfiuqhf");
    ...
    public PacketChannel(String modId, Class<? extends AbstractPacket>... packetTypes)
    {
        ...
        for(Class<? extends AbstractPacket> packetType : packetTypes)
        {
            ...
            {
                FractalCommons.internalLogger.logWarn("Channel " + modId + " is reregistering packet types!");
            }
        }
    ...
    public void registerPacket(String modId, int i, Class<? extends AbstractPacket> packetClass)
    {
        ...
        {
            FractalCommons.internalLogger.logWarn("Could not create packet for class " + packetClass.getName() + " for channel " + modId + ". Is there a default constructor in that class?");
            throw Throwables.propagate(e);
        }
    }
