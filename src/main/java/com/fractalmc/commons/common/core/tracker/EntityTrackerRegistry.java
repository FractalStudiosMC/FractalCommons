package com.fractalmc.commons.common.core.tracker;
    ...
    public class Entry
    {
        ...
        public Entry addAdditionalTrackerInfo(Class<? extends IAdditionalTrackerInfo> tracker)
        {
            ...
            for(EntityInfo info : trackedInfo)
            {
                ...
                {
                    FractalCommons.internalLogger.logWarn("Error creating tracker: " + tracker.getName());
                    e.printStackTrace();
                }
            }
            return this;
        ...
        public boolean update()
        {
            ...
            for(Class<? extends IAdditionalTrackerInfo> tracker : additionalInfo)
            {
                ...
                {
                    FractalCommons.internalLogger.logWarn("Error creating trackers: " + tracker.getName());
                    e.printStackTrace();
                }
            }
