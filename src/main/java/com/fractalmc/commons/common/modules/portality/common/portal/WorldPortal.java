package com.fractalmc.commons.common.modules.portality.common.portal;
...
//    private boolean cullRender = true;
    ...
    {
        return FractalCommons.config.renderDistanceChunks == 0 ? Minecraft.getMinecraft().gameSettings.renderDistanceChunks : FractalCommons.config.renderDistanceChunks;
    }
}
